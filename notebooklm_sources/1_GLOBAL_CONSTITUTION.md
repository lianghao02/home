# 📜 全域開發憲法 (Global Development Constitution) v6.0 終極大一統版
...
- **100% 台灣繁體中文鐵律 (嚴禁中國大陸用語)**：
  - 思考過程、對話溝通、程式碼註解、Git 提交訊息與專案文件，一律強制使用標準台灣繁體中文與台灣技術習慣用語。
  - **嚴禁簡體字與大陸用語**（如：信息->訊息、程序->程式、項目->專案、菜單->選單、文檔->文件、默認->預設、軟體->軟體、實時->即時、刷新->重新整理、鏈接->連結）。
